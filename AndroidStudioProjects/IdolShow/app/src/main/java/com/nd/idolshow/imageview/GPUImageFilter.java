...
//import rom.nd.com.whitening.OpenGlUtils;
...
public class GPUImageFilter
{
    ...
    private boolean mbIsAddBlendImageProcess;
    ...
    public GPUImageFilter(final String vertexShader, final String fragmentShader)
    {
        ...
        mbIsAddBlendImageProcess = false;
    }
    ...
    // 混合
    public void onDraw(final int textureId1, final int textureId2, final FloatBuffer cubeBuffer, final FloatBuffer textureBuffer)
    {
        GLES20.glUseProgram(mGLProgId);
        runPendingOnDrawTasks();
        if (!mIsInitialized)
    ...
    protected void setTexture(final int addTextureId)
    {
    }

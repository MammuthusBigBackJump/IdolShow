...
//
//        // test///
//        "    if (textureCoordinate.x > 0.00001 && textureCoordinate.x < 0.99999)\n" +
//        "    {\n" +
//        "        if (textureCoordinate.y > 0.00001 && textureCoordinate.y < 0.99999)\n" +
//        "        {\n" +
//        "            gl_FragColor = vec4(mix(minOutput, maxOutput, pow(min(max(textureColor.rgb-levelMinimum, vec3(0.0)) \n" +
//        "                      / (levelMaximum - levelMinimum), vec3(1.0)), 1.0 /levelMiddle)), textureColor.a); \n" +
//        "        }\n" +
//        "        else \n"+
//        "        {\n" +
...
//        " }\n";
    ...
    {
        this(new float[]{0.0f, 0.0f, 0.0f}, //min
             new float[]{1.0f, 1.0f, 1.0f}, //mid
             new float[]{1.0f, 1.0f, 1.0f}, //max
             new float[]{0.0f, 0.0f, 0.0f}, //minOut
             new float[]{1.0f, 1.0f, 1.0f});//maxOut
    }

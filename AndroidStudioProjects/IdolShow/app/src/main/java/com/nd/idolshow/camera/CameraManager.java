package com.nd.idolshow.camera;
...
import com.nd.idolshow.facetest.OnlineFaceDemo;
...
//        if (ImageUtils.isSquare(photo.getImageUri())) {
            Intent newIntent = new Intent(activity, OnlineFaceDemo.class);
...
//            System.out.println("______________________CropPhotoActivity");
//        }
    }

...
public class GPUImageView extends FrameLayout
{
    ...
    private void init(Context context, AttributeSet attrs)
    {
        ...
        mGLSurfaceView.setZOrderOnTop(false);//control surfaceView is placed on top of its window
        mGLSurfaceView.setEGLConfigChooser(8, 8, 8, 8, 16, 0);//RGBA depth stencil
